...
|----------------------------------|-------------|-----------------|------------------|
| X (диаметр шарика)               | Целое число | 1               | 2<sup>31</sup>-1 |           
| A (диаметр первого отверстия)    | Целое число | 1               | 2<sup>31</sup>-1 |
| B (диаметр второго отверстия)    | Целое число | 1               | 2<sup>31</sup>-1 |
| C (диаметр третьего отверстия)   | Целое число | 1               | 2<sup>31</sup>-1 |
| D (диаметр четвертого отверстия) | Целое число | 1               | 2<sup>31</sup>-1 |
#### Данные на выход
...
4. Тест на `X = A` (шарик и первое отверстие имеют одинаковый диаметр):
 ...
 5. Тест на `X > C` (шарик не проходит через третье отверстие):
 ...
 6. Тест на `X > D` (шарик не проходит через четвертое отверстие):
